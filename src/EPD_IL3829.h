...
// Полноценный независимый драйвер IL3829, совместимый по API с EPD_Base
class EPD_IL3829 : public EPD_Base {
public:
    explicit EPD_IL3829(const EPDConfig& cfg);
    ~EPD_IL3829() override;
...
private:
    ...
    // IL3829 specifics (минимально; уточнение по даташиту позже)
