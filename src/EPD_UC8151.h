...
// Полноценный независимый драйвер UC8151, совместимый по API с EPD_Base
class EPD_UC8151 : public EPD_Base {
public:
    explicit EPD_UC8151(const EPDConfig& cfg);
    ~EPD_UC8151() override;
...
private:
    ...
    // UC8151 specifics (минимально; можно уточнить позднее)
