/**
 * SSD1681 Demo 01: Temperature Display
...
static const GFXfont* FONT_BIG = &Orbitron_Light_32;
#include "../../../Fonts/GFXFF/font_mod/lange/timesbd10pt7b.h"
static const GFXfont* FONT_SMALL = &timesbd10pt7b;
...
void setup() {
  ...
  epd->setRotation(0);  // 90° counter-clockwise (left)
}
